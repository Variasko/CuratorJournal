...
{
    public class StudentClassHourService : ServiceBase<StudentClassHour>, IStudentClassHourService
    {
        public StudentClassHourService(IStudentClassHourRepository repository) : base(repository) { }
    }
}
