...
{
    public class TeacherCategoryService : ServiceBase<TeacherCategory>, ITeacherCategoryService
    {
        public TeacherCategoryService(ITeacherCategoryRepository repository) : base(repository) { }
    }
}
