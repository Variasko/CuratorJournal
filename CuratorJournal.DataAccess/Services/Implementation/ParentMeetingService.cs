...
{
    public class ParentMeetingService : ServiceBase<ParentMeeting>, IParentMeetingService
    {
        public ParentMeetingService(IParentMeetingRepository repository) : base(repository) { }
    }
}
