...
{
    public class StudentClassHourService : BaseService<StudentClassHour>, IStudentClassHourService
    {
        public StudentClassHourService(IBaseRepository<StudentClassHour> repository)
            : base(repository)
        {
        }
    }
