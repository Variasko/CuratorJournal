...
{
    public class IndividualWorkRepository : RepositoryBase<IndividualWork>, IIndividualWorkRepository
    {
        public IndividualWorkRepository(ApplicationContext context) : base(context) { }
    }
}
