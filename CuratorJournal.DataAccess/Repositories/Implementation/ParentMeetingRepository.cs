...
{
    public class ParentMeetingRepository : RepositoryBase<ParentMeeting>, IParentMeetingRepository
    {
        public ParentMeetingRepository(ApplicationContext context) : base(context) { }
    }
}
