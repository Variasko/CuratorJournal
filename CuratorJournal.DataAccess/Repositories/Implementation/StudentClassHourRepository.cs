...
{
    public class StudentClassHourRepository : RepositoryBase<StudentClassHour>, IStudentClassHourRepository
    {
        public StudentClassHourRepository(ApplicationContext context) : base(context) { }
    }
}
