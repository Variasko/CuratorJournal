...
{
    public class IndividualWorkRepository : BaseRepository<IndividualWork>, IIndividualWorkRepository
    {
        public IndividualWorkRepository(ApplicationContext context)
            : base(context) { }
    }
}
